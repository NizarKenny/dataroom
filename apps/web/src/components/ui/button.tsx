...
/**
 * The buttons from the style reference. The two reds are not interchangeable:
 * `danger` is the trigger, quiet because a confirming dialog stands behind it,
 * and `destructive` is the button in that dialog, filled because nothing does.
 */
const button = cva(
